...
export function RegistrationPage() {
    ...
    const resetForm = () => {
        setFormData({
            patientNameKorean: '', patientNameEnglish: '', dateOfBirth: '', gender: '',
            contactNumber: '', deviceId: '', sensorType: '', registrationDate: '', hospital: ''
        });
    };
        ...
        <div className="min-h-full bg-gray-50 flex flex-col">
            ...
            <div className="px-4 py-2 bg-white border-b border-gray-200 flex-shrink-0">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-gray-900 text-md font-medium">{t('registration.title')}</h1>
                </div>
            </div>

            {/* UPDATED: wider cards on small screens */}
            <div className="flex-1 overflow-auto px-1 py-3 sm:p-3">
                {/* UPDATED: full width on mobile, original constraint from sm+ */}
                <div className="w-full max-w-none sm:max-w-[1400px] sm:mx-auto">
                    <form onSubmit={handleSubmit} className="space-y-2">

                        {/* Basic Information - Horizontal Row */}
                        <BasicInfoForm
                            formData={formData}
                            language={language}
                            t={t}
                        ...
                        {/* Split Section: Device & Care Facility Information */}
                        ...
                        {/* Submit Buttons - Centered horizontally and vertically in container */}
                        <SubmitActions
                            t={t}
                            onReset={resetForm}
                        />
